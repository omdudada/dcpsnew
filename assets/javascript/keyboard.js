...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "Devanagari";// Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 5;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  this.VKI_imageURI = imgpath+"keyboard.png";  // If empty string, use imageless mode
    ...
    var tr = document.createElement('tr');
      var th = document.createElement('th');
        ...
        var kbSelect = document.createElement('div');
			...
			// Shantanu Naik Added to remove the display the Language select box.
  ...
  var tbody = document.createElement('tbody');
    var tr = document.createElement('tr');
      var td = document.createElement('td');
        ...
        if (this.VKI_deadBox) {
			// Shantanu Naik commented this to hide the display the Dead key checkbox
