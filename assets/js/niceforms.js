...
var imagesPath = imgpath1+"images/";
	...
	nf.start = function() {
		...
		for(var w = 0; w < allInputs.length; w++) {
			switch(allInputs[w].type) {
				case "text": case "password": {if(allInputs[w].name == "recaptcha_response_field") { } else this.add_inputText(allInputs[w]); break;}
		...
		for(var w = 0; w < allTextareas.length; w++) {
			if(allTextareas[w].name == "ajaxfilemanager" || allTextareas[w].name =='simpajaxfilemanager'){
