    ...
    else
    {
        for(i = 0; i < document.forms[frm].length; i++)
        {
            if(document.forms[frm].elements[i].name == field)
            {
                ...
                else if (datatype == "3mobilenumber")
                {
                    if (check_mobile3(needle) == false) state = false;
                }
...
function check_mobile3(value) /*allowed only   0 to 9 with 10 digit only*/ 
{
    var x=value;
