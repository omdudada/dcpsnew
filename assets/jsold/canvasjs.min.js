        ...
        W = function(m, s, q) {
            ...
            for (var V = 0; Q && V < Q.length; V++)
                if (s = Q[V], "." === s && 0 > C) C = V;
                    ...
                    if ("%" === s) z *= 100;
                    else if ("\u2030" === s) { z *= 1E3; continue } else if ("," === s[0] && "." === s[s.length - 1]) {
    ...
    x.Chart = function() {
        ...
        function s(a, f, b) {
            if (a && f && b) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    ...
                    try { window.navigator.msSaveBlob(f, b), e = !0 } catch (k) { g.dataset.downloadurl = [c, g.download, g.href].join(":"), g.href = window.URL.createObjectURL(f) }
                }
                if (!e) try {
        ...
        function q(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"),
                    ...
                    this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, N(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), N(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), N(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), N(this.overlaidCanvas, "mousedown", function(a) {
                        b._mouseEventHandler(a);
                        wa(b._dropdownMenu)
                    }), N(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }), N(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart",
        ...
        q.prototype.calculateAutoBreaks = function() {
            ...
            for (var c, e = this, g = !1, h = 0; h < this._axes.length; h++)
                if (this._axes[h].scaleBreaks && this._axes[h].scaleBreaks.autoCalculate && 1 <= this._axes[h].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[h].scaleBreaks.collapsibleThreshold) || 10, 10); l++) this._axes[h].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity })
                }
            if (g) {
                            ...
                            if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !S)))
                                if ("number" !== typeof r[D].y) 0 < D && !S && (k.connectNullData ? c.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (q[q.length -
                                    ...
                                    if (0 < r[D].markerSize || 0 < k.markerSize) {
                                        ...
                                        h.push(y);
                                        s = R(s);
                                        v && h.push({ x: u, y: S, ctx: e, type: y.type, size: y.size, color: s, borderColor: s, borderThickness: y.borderThickness })
                                    }(r[D].indexLabel || k.indexLabel || r[D].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: r[D], dataSeries: k, point: { x: u, y: S }, direction: 0 > r[D].y === a.axisY.reversed ? 1 : -1, color: w });
                                    S = !1
                                }
                    f(q)
                }
                            ...
                            if (w = n[d].x.getTime ? n[d].x.getTime() : n[d].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m)))
                                if ("number" !== typeof n[d].y) 0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) &&
                                    ...
                                    if (0 !== n[d].markerSize && (0 < n[d].markerSize || 0 < p.markerSize)) {
                                        ...
                                        l.push(da);
                                        I = R(I);
                                        v && l.push({ x: w, y: m, ctx: e, type: da.type, size: da.size, color: I, borderColor: I, borderThickness: da.borderThickness })
        ...
        q.prototype.print = function() {
            ...
            setTimeout(function() {
                c.focus();
                c.print();
                setTimeout(function() { b._canvasJSContainer.removeChild(f) }, 1E3)
            }, 500)
        };
