			...
			<div class="col-lg-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<form action="<?php echo base_url('admin/masterdata/addEmp') ?>" method="post" name="typicaltypes" id="typicaltypes" enctype="multipart/form-data" novalidate="novalidate">
							<div class="form-row">
							    ...
							    <div class="form-group col-md-4">
									...
									<input type="text" name="fixed_pay" id="fixed_pay" class="form-control" placeholder="Fixed Pay">
							    </div>
							    <div class="form-group col-md-4">
