...
<div class="content-wrapper" style="min-height: 970.3px; height: auto !important;">
	<section class="content-header">
		<div class="heading-icon-badge"><img src="<?php echo base_url('assets/images/user_edit.png'); ?>" alt="Edit Employee"></div>
		<h1>Edit Employee</h1>
		<!-- <ol class="breadcrumb">
						...
						<form action="<?php echo base_url() ?>admin/masterdata/editEmp/<?php echo $results['id']; ?>" method="post" name="typicaltypes" id="typicaltypes" enctype="multipart/form-data" novalidate="novalidate">
							<div class="form-row">
							    ...
							    <div class="form-group col-md-4">
									...
									<input type="text" name="wef_date" id="wef_date" class="form-control datepick" data-provide="datepicker" data-date-format="dd.mm.yyyy" data-date-autoclose="true" value="<?php echo $results['joining_date']; ?>" placeholder="Joining Date" autocomplete="off">
							    </div>
