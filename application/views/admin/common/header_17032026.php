          ...
          <div id="defaultmenu" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              ?>
               ...
               <li><a href="//dcps.nmc.gov.in/admin/misreport/ledger_report_new">Ledger Report</a></li>
               <!--<li><a href="//dcps.nmc.gov.in/admin/misreport/broad_sheet_report">Borad Sheet Report</a></li>-->
               <li><a href="//dcps.nmc.gov.in/admin/monthly-record">Edit Month Wise Deduction Record</a></li>
               <li><a href="<?=base_url('admin/edit-missing-month-year-records')?>">Pending Month & Year Records</a></li>
               <li><a href="//dcps.nmc.gov.in/admin/misreport/deduction_report">Deduction Report</a></li>
               <li><a href="//dcps.nmc.gov.in/admin/dcps-deduction-record">Edit Employee Wise Deduction Record</a></li>
               
               <li><a href="//dcps.nmc.gov.in/admin/add-edit-master-record">Add Master</a></li>
