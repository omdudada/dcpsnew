            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Search DCPS Deduction Record</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="post" name="typicaltypes" id="typicaltypes" enctype="multipart/form-data" novalidate="novalidate">
							<div class="form-row">
							    ...
							    <div class="form-group col-md-3">
							     	<label for="inputState" class="required">Salary Month</label>
							     	<select id="for_month" name="for_month" class="form-control">
							       		<option name="month" selected value="">Select Salary Month</option>
							        <?php
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function getCustomerDetails(){
			...
			$.ajax({
				type : 'POST',
				url    : '<?php echo base_url("ajax/getDeatailsOfDeductionRec"); ?>',
				data : { id: employee_id, month:month, year:year },
