                ...
                <div class="box">
                    <div class="box-header with-border">
                		...
                		?>
                			...
                			<a class="btn btn-primary btnPrint" style="float:right;" href="<?=base_url();?>admin/misreport/deduction_report/year/<?=$this->input->post('year');?>/option/print">प्रिंट
                			</a>
                		<?php
                		    }
                		?>
...
(<?= $searchData['f_year']; ?>)                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"><?= !empty($ownerDetail['emp_id']) ? $ownerDetail['emp_id'] : ''; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"><?= !empty($ownerDetail['joining_date']) ? $ownerDetail['joining_date'] : ''; ?></td>
                                            ...
                                            : [];
                                                            ...
                                                            if (!empty($records)) {
                                                                ...
                                                                foreach ($records as $row) {
                                                                    $basic = isset($row['basic']) ? $row['basic'] : 0;
                                                                    $grade_pay = isset($row['grade_pay']) ? $row['grade_pay'] : 0;
                                                                    $da = isset($row['da']) ? $row['da'] : 0;
                                                                    $total_salary = isset($row['total_salary']) ? $row['total_salary'] : 0;
                                                                    $ideal_contri = isset($row['Ideal_contribution_of_employee_for_DCPS']) ? $row['Ideal_contribution_of_employee_for_DCPS'] : 0;
                                             if($row['salary_type'] == "Regular"){
                                               $emp_sup_contri = isset($row['emp_DCPS_contribution']) ? $row['emp_DCPS_contribution'] : 0;  
                                             }    
                                             else{
                                                 $emp_sup_contri = isset($row['emp_DCPS_supplimentory_contribution']) ? $row['emp_DCPS_supplimentory_contribution'] : 0;
                                             }
    ...
    : (isset($yearKeys[1]) ? $yearKeys[1] + 1 : null);
                                                            ...
                                                            if (!empty($records)) {
                                                                ...
                                                                foreach ($records as $row) {
                                                                    ...
                                                                    $total_salary = isset($row['total_salary']) ? $row['total_salary'] : 0;
                                                                    $ideal_contri = isset($row['Ideal_contribution_of_employee_for_DCPS']) ? $row['Ideal_contribution_of_employee_for_DCPS'] : 0;
                                                                    $emp_sup_contri = (isset($row['emp_DCPS_contribution']) ? $row['emp_DCPS_contribution'] : 0)+(isset($row['emp_DCPS_supplimentory_contribution']) ? $row['emp_DCPS_supplimentory_contribution'] : 0);
                                                                    $difference = $emp_sup_contri - $ideal_contri;
