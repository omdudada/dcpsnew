            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border no-print">
                        <h3 class="box-title">Provisional Ledger Report</h3>
                        <?php if (!empty($this->input->post('year'))) { ?>
                            <a class="btn btn-primary" style="float:right; margin-left:8px;" href="javascript:void(0);"
                                onclick="printPdfReport();">Print</a>
                            <a class="btn btn-success" style="float:right;"
                                href="<?= base_url(); ?>admin/misreport/provisional_ledger_report/year/<?= $this->input->post('year'); ?>/option/excel">Export
                                Excel</a>
                        <?php } ?>
                    </div>

                    <div class="box-body">
                        <form action="" method="post" name="finalLedgerForm" id="finalLedgerForm"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="pay_center" name="pay_center" class="form-control">
                                        ...
                                        <?php if (!empty($paycenterData)) {
                                            foreach ($paycenterData as $row) { ?>
                                                <option value="<?= htmlspecialchars($row['pay_center']); ?>">
                                                    <?= htmlspecialchars($row['pay_center']); ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                                </div>
                                    ...
                                    <select id="employee" name="emp_id" class="form-control">
                                        ...
                                        <?php if (!empty($employeeData)) {
                                            ...
                                            foreach ($employeeData as $row) { ?>
                                                <option value="<?= $row['emp_id']; ?>"><?= $row['emp_name']; ?>
                                                    (<?= $row['emp_id']; ?>)
                                                </option>
                                            <?php }
                                        } ?>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="year" name="year" class="form-control">
                                        ...
                                        <?php for ($start = 2005; $start <= 2014; $start++) {
                                            $end = $start + 1; ?>
                                            <option value="<?= htmlspecialchars($start); ?>">
                        ...
                        <?php if (!empty($ownerDetails) && !empty($finalLedger) && !empty($searchData['f_year'])) { ?>
                                    ...
                                    <div style="overflow-x:auto; width:100%;">
                                        <table class="table table-striped table-bordered table-hover" cellspacing="0"
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    <th style="text-align:center;" colspan="21">परिभाषित अंशदान निवृत्ती वेतन
                                                        योजना - वार्षिक विवरणपत्र (<?= $searchData['f_year']; ?>)</th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= !empty($ownerDetail['joining_date']) ? $ownerDetail['joining_date'] : ''; ?>
                                                    </td>
                                                    <th>पे सेंटर</th>
                                                ...
                                                <?php foreach ($fltRows as $i => $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right; font-weight:600;">
                                                            <?= _n0($row['emp_interest']); ?></td>
                                                        <td style="text-align:right; font-weight:600;">
                                                            <?= _n0($row['nmc_interest']); ?></td>
                                                        <td style="text-align:right; font-weight:600;">
                                                            <?= _n0($row['total_interest']); ?></td>
                                                        <td><?= htmlspecialchars($rateLabel); ?></td>
                                                    </tr>
                                                <?php } ?>
                                                <tr>
                                                    <td colspan="5" style="text-align:center;"><strong>एकुण
                                                            <?= htmlspecialchars((string) $searchData['f_year']); ?></strong>
                                                    </td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['emp_regular']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['emp_supp']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0(isset($totShow['emp_diff']) ? $totShow['emp_diff'] : 0); ?></strong>
                                                    </td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['nmc_regular']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['nmc_supp']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0(isset($totShow['nmc_diff']) ? $totShow['nmc_diff'] : 0); ?></strong>
                                                    </td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['loan_installment']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['total_deposit']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['loan_taken']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['emp_base']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['nmc_base']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['total_base']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['emp_interest']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['nmc_interest']); ?></strong></td>
                                                    <td style="text-align:right;">
                                                        <strong><?= _n0($totShow['total_interest']); ?></strong></td>
                                        ...
                                        <tr>
                                            <td class="final-ledger-cert-box">
                                                ...
                                                <p style="margin:0;">
                                                    ...
                                                    अन्वये सदर कर्मचाऱ्यांच्या नवीन परिभाषित अंशदान निवृत्तीवेतन योजनेबाबतच्या
                                                    प्रति माह अंशदान वर्गणी कपाती विभागामार्फत प्रमाणित करण्यात येत असून,
                                                    त्यानुसार सदर लेखांकन अचूक व बरोबर आहे. सदर बाबतीत भविष्यात काही आक्षेप
                                                    आल्यास किंवा काही बदल असल्यास त्याची सर्वस्वी जबाबदारी कार्यकारी विभागाची
                                                    राहील.
                                                </p><br />
                                                ...
                                                <table class="final-ledger-summary-table" cellspacing="0">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="fls-desc">कर्मचाऱ्याने काढलेल्या कर्ज रक्कमेचा एकूण हप्ता
                                                            (जमा)</td>
                                                        <td class="fls-amt"><?= _nf($totShow['loan_installment']); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fls-num">4</td>
                                                        <td class="fls-desc">एकूण कर्मचारी वर्गणी व कर्मचाऱ्याने काढलेल्या कर्ज
                                                            रक्कमेचा हप्ता : जमा (2+3)</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fls-desc">मार्च
                                                            <?= $fyMarchYear ? htmlspecialchars((string) $fyMarchYear) : ''; ?>
                                                            अखेर शिल्लक (6-7+10)</td>
                            ...
                            <?php } ?>
                        <?php } else { ?>
                            <div class="alert alert-info no-print">Please select Year (and optionally Employee) and click
                                Search.</div>
                        <?php } ?>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function printPdfReport() {
        ...
        frm.action = "<?= base_url(); ?>admin/misreport/generate_provisional_ledger_report_mpdf";
        frm.target = "_blank";
        frm.submit();
        setTimeout(function () {
