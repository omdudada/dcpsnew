                        		...
                        		<table id="" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        			<thead class="bg-primary123">
                        				<tr>
                        					...
                        					<td><?=(isset($ownerDetail['emp_id']) && $ownerDetail['emp_id'] !="")?$ownerDetail['emp_id']:"" ?></td>
                        					<th class="">कर्मचारी नाव</th>
                        					<td colspan ="5"><?=(isset($ownerDetail['emp_name']) && $ownerDetail['emp_name'] !="")?$ownerDetail['emp_name']:"" ?></td>
										</tr>	
										<tr>
                        					<th class="">कर्मचारी नियुक्ती दिनांक</th>
                        					<td><?=(isset($ownerDetail['joining_date']) && $ownerDetail['joining_date'] !="")? $ownerDetail['joining_date']:"" ?></td>
