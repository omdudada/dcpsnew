...
<div class="content-wrapper" style="min-height: 970.3px; height: auto !important;">
    <section class="content-header">
        ...
        <h1>Year-wise Final Ledger Summary Report</h1>
    </section>
                                            ...
                                            <thead class="bg-primary123">
                                                <tr>
                                                    <th style="text-align:center;" colspan="4">
                                                        <strong>Year-wise Final Ledger Summary Report</strong>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th style="text-align:center;" colspan="4">
...
<script type="text/javascript">
    ...
    function printPdfReport() {
        ...
        frm.action = "<?=base_url();?>admin/misreport/generate_yearwise_final_ledger_summary_report_mpdf";
        frm.target = "_blank";
        frm.submit();
        setTimeout(function(){
    ...
    function exportExcelReport() {
        ...
        var oldAction = frm.action;
        var oldTarget = frm.target;
        frm.action = "<?=base_url();?>admin/misreport/yearwise_final_ledger_summary_report/option/excel";
        frm.target = "_blank";
        frm.submit();
        setTimeout(function(){
            frm.action = oldAction;
