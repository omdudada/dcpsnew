                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-demand" >
							<?php foreach ($data as $cdata) {?>
								
								<?php //echo "<pre>";print_r($cdata);die(); ?>          	
								<div class="table-responsive">
									<table border="0" cellpadding="0" cellspacing="0" id="example" style="width:100%; margin: 20px auto; text-align: center; border-radius: 10px; border:solid 2px #347ab652; border-collapse: unset; padding:15px;font-size: 15px;" >
...
<?php echo round($cdata['opening_balance'],2);?>
											</td>
										...
										<tr style="padding:  18px;">
											...
											<th style="padding:  18px; border: solid 1px #000; 
											text-align: left;"><u> For Month : </u></th>
											
											<td id="for_month" style="border: solid 1px #000; text-align: center;  font-size: 20px;font-weight: bold;" ><u><?php echo $cdata['for_month'];?></u>
											</td>
											
											<th style="padding:  18px; border: solid 1px #000; 
											text-align: left;"><u>For Year : </u></th>
											
											<td id="for_year" style="border: solid 1px #000; text-align: center; font-size: 20px;font-weight: bold;" ><u>
