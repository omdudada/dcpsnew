...
<div class="content-wrapper" style="min-height: 970.3px; height: auto !important;">
	<section class="content-header">
		<div class="heading-icon-badge"><img src="<?php echo base_url('assets/images/month_wise_deduction.jpg'); ?>" alt="Edit DCPS Master Data"></div>
						...
						<form action="<?php echo base_url(); ?>admin/report/editDeductionRecord/<?php echo $editData['id']; ?>" method="post" name="typicaltypes" id="typicaltypes" enctype="multipart/form-data" novalidate="novalidate">
							<div class="form-row">
							    ...
							    <div class="form-group col-md-4">
									...
									<input type="text" name="Ideal_contribution_of_employee_for_DCPS" id="Ideal_contribution_of_employee_for_DCPS" class="form-control" placeholder="Ideal Contribution Of Employee For DCPS" value="<?php echo $editData['Ideal_contribution_of_employee_for_DCPS']; ?>">
							    </div>
							    <div class="form-group col-md-4">
									<label for="inputCity">Ideal Contribution Of NMC For DCPS</label>
									<input type="text" name="Ideal_contribution_of_NMC_for_DCPS" id="Ideal_contribution_of_NMC_for_DCPS" class="form-control" placeholder="Ideal Contribution Of NMC For DCPS" value="<?php echo $editData['Ideal_contribution_of_NMC_for_DCPS']; ?>">
							    </div>
							    <div class="clearfix"></div>
							    <div class="form-group col-md-4">
							    ...
							    <div class="form-group col-md-4">
									<label for="inputCity">Employee DCPS Contribution</label>
									<input type="text" name="emp_DCPS_contribution" id="emp_DCPS_contribution" class="form-control" placeholder="Employee DCPS Contribution" value="<?php echo $editData['emp_DCPS_contribution']; ?>">
							    </div>
							    <div class="form-group col-md-4">
									<label for="inputCity">Employee DCPS Supplimentory Contribution</label>
									<input type="text" name="emp_DCPS_supplimentory_contribution" id="emp_DCPS_supplimentory_contribution" class="form-control" placeholder="Employee DCPS Supplimentory Contribution" value="<?php echo $editData['emp_DCPS_supplimentory_contribution']; ?>">
							    </div>
							    <div class="clearfix"></div>
							    <div class="form-group col-md-4">
									<label for="inputCity">NMC's DCPS Contribution</label>
									<input type="text" name="NMC_DCPS_contribution" id="NMC_DCPS_contribution" class="form-control" placeholder="NMC's DCPS Contribution" value="<?php echo $editData['NMC_DCPS_contribution']; ?>">
							    </div>
							    <div class="form-group col-md-4">
									<label for="inputCity">NMC's Supplimentory DCPS Contributio</label>
									<input type="text" name="NMC_supplimentory_DCPS_contribution" id="NMC_supplimentory_DCPS_contribution" class="form-control" placeholder="NMC's Supplimentory DCPS Contributio" value="<?php echo $editData['NMC_supplimentory_DCPS_contribution']; ?>">
							    </div>
							    <div class="form-group col-md-4">
							    ...
							    <div class="form-group col-md-4">
									<label for="inputCity">Supplimentory Loan Installment Paid</label>
									<input type="text" name="supplimentory_loan_installment_paid" id="supplimentory_loan_installment_paid" class="form-control" placeholder="Supplimentory Loan Installment Paid" value="<?php echo $editData['supplimentory_loan_installment_paid']; ?>">
							    </div>
							    <div class="clearfix"></div>
							    <div class="form-group col-md-4">
