...
<div class="content-wrapper" style="min-height: 970.3px; height: auto !important;">
    <section class="content-header">
        <div class="heading-icon-badge"><img src="<?php echo base_url('assets/images/final_ledger.jpg'); ?>" alt="Calculate Opening Balance"></div>
        <h1>Calculate Opening Balance</h1>
        <!-- <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Calculate Opening Balance(Only Admin User)</h3>
                    </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function getCustomerDetails(){
			...
			$.ajax({
				type : 'POST',
				url    : '<?php echo base_url("ajax/checkByEmpForDetails"); ?>',
				data : { id: employee_id},
