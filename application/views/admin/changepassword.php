                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="password" id="password" value=""
                                            class="form-control" size="54" placeholder="New Password">
                                    </div>
                                </div>
                            </div>
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="cfmpassword" id="cfmpassword" value=""
                                            class="form-control" size="54" placeholder="Confirm Password">
