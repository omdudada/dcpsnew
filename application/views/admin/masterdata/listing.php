...
<div class="content-wrapper" style="min-height: 970.3px; height: auto !important;">
    <section class="content-header">
        <div class="heading-icon-badge"><img src="<?php echo base_url('assets/images/final_ledger.jpg'); ?>" alt="Master Record"></div>
        <h1>Master Record</h1>
        <!-- <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="post" name="typicaltypes" id="typicaltypes" enctype="multipart/form-data" novalidate="novalidate">
							<div class="form-row">
							    ...
							    <div class="form-group col-md-3">
							     	<label for="inputState" class="">Month</label>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function getCustomerDetails(){
			...
			$.ajax({
				type : 'POST',
				url    : '<?php echo base_url("ajax/getcustomerdetail"); ?>',
